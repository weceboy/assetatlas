...
ASSETS.mkdir(parents=True,exist_ok=True);ATLAS.mkdir(parents=True,exist_ok=True);app.mount('/files/assets',StaticFiles(directory=ASSETS),name='assets');app.mount('/files/atlases',StaticFiles(directory=ATLAS),name='atlases')
